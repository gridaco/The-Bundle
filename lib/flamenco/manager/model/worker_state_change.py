...
class WorkerStateChange(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status_requested, *args, **kwargs):  # noqa: E501
        """WorkerStateChange - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, status_requested, *args, **kwargs):  # noqa: E501
        """WorkerStateChange - a model defined in OpenAPI
